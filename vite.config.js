  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        start_url: ".",
        id: ".",
        short_name: "Freshbasket - E-Commerce Website",
        name: "Freshbasket | React eCommerce Admin Dashboard",
        description:
          "Freshbasket : React Grocery & Organic Food Store e-commerce Admin Dashboard",
        icons: [
          {
            src: "favicon.ico",
            sizes: "48x48",
